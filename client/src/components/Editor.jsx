...
const Editor = () => {
  ...
  return (
    <div className="w-screen min-h-screen bg-gray-100 flex flex-col p-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow">
        {/* Main Writing Area + Tools */}
        <div className="md:col-span-2 flex flex-col">
          <div className="bg-white shadow-lg rounded-lg p-6 mb-8 flex flex-col">
            ...
            <textarea
              ...
              rows={10}
              className="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none text-black bg-white"
            />
          ...
          {/* Selected Sentence and Rephrased Sentences */}
          {selectedSentence && (
            <div className="bg-white shadow-lg rounded-lg p-6 my-8">
              ...
              <p className="mb-4 text-black">{selectedSentence}</p>
          ...
          {rephrasedSentences.length > 0 && (
            <div className="bg-white shadow-lg rounded-lg p-6 my-8">
              ...
              {rephrasedSentences.map((sentence, index) => (
                ...
                >
                  <p className="mb-2 text-black">{sentence}</p>
                  <Button
...
const ResultSection = ({ title, text, onAccept, icon }) =>
  text && (
    <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col h-full">
      ...
      <p className="mb-4 text-black flex-grow overflow-auto">{text}</p>
